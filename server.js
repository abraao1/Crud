...
const { ObjectId } = require('mongodb'); //Importando o ObjectId do MongoDB
const app = express() //Inicializando o express

//Trecho responsável pela conexão com o Banco de Dados na Nuvem
...
app.set('view engine', 'ejs') //Configurando a view engine
...
//Trecho de código responsável por acessar as collection no mesmo banco de dados
...
//Trecho responsável por listar os cadastros feitos no banco de dados
...
//Trecho responsável por salvar no banco de dados MongoDB
...
//Trecho do código responsável por editar as informações e atualizá-las
...
//Trecho responsável por deletar as informações do banco de dados
